...
The Vercel production frontend now rewrites `/api/*` to the temporary HTTPS VPS endpoint `56-124-115-189.nip.io`; the rewrite is intended for testing until a permanent Taiju domain is registered.
